...
public class Falcon extends Sprite {
	...
	public static final int MAX_SPEED = 28;
...
//		}
	...
	public void autoFire() {
		for (int i = -fireLevel; i < fireLevel+1; i++) {
			// Create a new bullet and add it to the game's operations queue
			Bullet bullet = new Bullet(this);

			bullet.setDeltaX(bullet.getDeltaX()+i*10);
			bullet.setDeltaY(bullet.getDeltaY()+i*10);
